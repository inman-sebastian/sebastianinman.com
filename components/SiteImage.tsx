    ...
    if (caption) {
      return (
        <figure className="w-full">
          {img}
          {/* Styled like a small notice card: light terracotta field,
              slightly darker terracotta border, photo icon prefix */}
          <figcaption className="mt-3 flex items-start gap-2.5 rounded-lg border border-terracotta/25 bg-terracotta-tint/60 px-3.5 py-2.5 text-left text-sm leading-snug text-ink/80">
            <svg
