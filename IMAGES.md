...
- [ ] `public/images/home-hero.jpg` (**16:9**, e.g. 2560×1440): Full-width splash, **pure landscape**. One continuous, peaceful Southern Oregon valley at golden hour with an asymmetrical composition: a big calm cream sky and gently rolling golden fields fill most of the frame, and layered pine-covered hills with soft mountain silhouettes rise gradually along the right side, where a winding dirt road drifts into the distance and a few soft wildflowers sit in the lower corner. Low horizon, generous open sky, serene and uncluttered. **No people, animals, buildings, signs, words, or lettering anywhere.** (The hero text overlays the open-sky side, so the composition needs that area calm, but do NOT phrase it as "left half empty" in prompts: explicit half-by-half instructions make generators draw a literal seam down the middle. Describe one scene with asymmetric weight instead. Other history: v1 had a signed storefront "The Valley Post" that read like the business name; v2's floating-envelope metaphor felt postal and ungrounded. The hero is atmosphere only; the headline carries the message.)
