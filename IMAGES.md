...
- [ ] `public/images/home-hero.jpg` (**16:9**, e.g. 2560×1440): Full-width splash. A peaceful Southern Oregon valley at golden hour with pine-covered hills and soft mountain silhouettes. The LEFT HALF must be calm open sky and gentle fields with almost no detail (hero text sits there). On the RIGHT, one relaxed person sits in a wooden chair on a grassy rise overlooking the valley, coffee in hand, while three or four paper envelopes drift gently upward on their own. **Absolutely no buildings, storefronts, signs, words, or lettering anywhere** (v1 had a storefront named "The Valley Post," which read like the business name). Keep it simple: one focal point, generous negative space; busier versions were overwhelming at display size. Current uploaded version works but needs regenerating to drop the storefront.
